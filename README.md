...
Legend: 
The name of the notebooks start with a number that indicates the order in which these techniques and methods are discussed in the research paper. Note that "A" corresponds to extra/appendix notebooks not directly relevant to the analysis.
